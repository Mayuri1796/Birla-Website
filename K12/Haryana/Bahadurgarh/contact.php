  ...
  <main id="birla">
        ...
        <div class="row">
          <div class="col-md-3">
            <div class="call_section d-flex align-items-center">
              ...
              <div class="para">
                <p><a class="text-black" href="tel: 91  9053901011"> 91 9053901011</a>></p>
              </div>
            </div>
          </div>
          <div class="col-md-5">
            <div class="address d-flex align-items-center">
              <i class="fa fa-map"></i>
              <p>Opposite Metro Pillar Number 860,
                Rohtak Road, Old NH-10, Bahadurgarh,
                Dist Jhajjar, Haryana - 124507, India</p>
            </div>
          </div>
          <div class="col-md-4">
            <div class="mail d-flex align-items-center">
              ...
              <div class="para">
                <p><a class="text-black" href="mailto: admin.bahadurgarh@birlaopenminds.com">
                    admin.bahadurgarh@birlaopenminds.com</a></p>
                <p><a class="text-black" href="mailto:  principal.bahadurgarh@birlaopenminds.com">
                    principal.bahadurgarh@birlaopenminds.com</a></p>
              </div>
            </div>
          </div>
        </div>
    ...
    <section class="map">
      <div class="container">
        <div class="col-md-12">
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3499.864441895225!2d76.92552481508402!3d28.6937013823937!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x38a8bed5f2cb6f99!2zMjjCsDQxJzM3LjMiTiA3NsKwNTUnMzkuOCJF!5e0!3m2!1sen!2sin!4v1669629217505!5m2!1sen!2sin"
    ...
    if (isset($_POST['submit'])) {
      ...
      $mail->addAddress('principal.bahadurgarh@birlaopenminds.com');
      $mail->isHTML(true);
