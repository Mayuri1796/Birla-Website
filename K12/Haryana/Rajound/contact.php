  ...
  <main id="birla">
        ...
        <div class="row">
          <div class="col-md-3">
            <div class="call_section d-flex align-items-center">
              ...
              <div class="para">
                <p><a class="text-black" href="tel: 91 9653424964"> 91 9653424964</a>></p>
              </div>
            </div>
          </div>
          <div class="col-md-5">
            <div class="address d-flex align-items-center">
              <i class="fa fa-map"></i>
              <p>Asandh Kaithal Road, Rajound,
                Dist- Kaithal, Haryana- 136044, India</p>
            </div>
          </div>
          <div class="col-md-4">
            <div class="mail d-flex align-items-center">
              ...
              <div class="para">
                <p><a class="text-black" href="mailto: admin.rajound@birlaopenminds.com">
                    admin.rajound@birlaopenminds.com</a></p>
                <p><a class="text-black" href="mailto:  principal.Rajound@birlaopenminds.com">
                    principal.rajound@birlaopenminds.com</a></p>
              </div>
            </div>
          </div>
        </div>
    ...
    <section class="map">
      <div class="container">
        <div class="col-md-12">
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d111048.06212068176!2d76.508183!3d29.567272!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0xa40e98321c132987!2sApollo%20International%20School%2C%20Rajound!5e0!3m2!1sen!2sin!4v1578637522087!5m2!1sen!2sin"
    ...
    if (isset($_POST['submit'])) {
      ...
      $mail->addAddress('principal.rajound@birlaopenminds.com');
      $mail->isHTML(true);
