  ...
  <main id="birla">
        ...
        <div class="row">
          <div class="col-md-3">
            <div class="call_section d-flex align-items-center">
              ...
              <div class="para">
                <p><a class="text-black" href="tel: +91 9622252221"> +91 9622252221</a> / <a class="num"
                    href="tel: +91 9622292221">
                    +91 9622292221 </a></p>
              </div>
            </div>
          </div>
          <div class="col-md-5">
            <div class="address d-flex align-items-center">
              <i class="fa fa-map"></i>
              <p>Opp. Sumo Taxi stand, Dak Banglow,
                Anantnag 192101, Jammu and Kashmir, India</p>
            </div>
          </div>
          <div class="col-md-4">
            <div class="mail d-flex align-items-center">
              ...
              <div class="para">
                <p><a class="text-black" href="mailto: admissions.anantnag@birlaopenminds.com">
                    admissions.anantnag@birlaopenminds.com</a></p>
                <p><a class="text-black" href="mailto:  principal.anantnag@birlaopenminds.com">
                    principal.anantnag@birlaopenminds.com</a></p>
              </div>
            </div>
          </div>
        </div>
    ...
    <section class="map">
      <div class="container">
        <div class="col-md-12">
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d13273.186961986004!2d75.1549507!3d33.7271421!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x86639bcc2aa97325!2sBirla%20Open%20Minds%20International%20School!5e0!3m2!1sen!2sin!4v1668764801647!5m2!1sen!2sin"
    ...
    if (isset($_POST['submit'])) {
      ...
      $mail->addAddress('principal.anantnag@birlaopenminds.com');
      $mail->isHTML(true);
