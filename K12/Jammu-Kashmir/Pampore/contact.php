  ...
  <main id="birla">
        ...
        <div class="row">
          <div class="col-md-3">
            <div class="call_section d-flex align-items-center">
              ...
              <div class="para">
                <p><a class="text-black" href="tel: +91 8899333684"> +91 8899333684</a> / <a class="num"
                    href="tel: +91 8899333685">
                    +91 8899333685 </a></p>
              </div>
            </div>
          </div>
          <div class="col-md-5">
            <div class="address d-flex align-items-center">
              <i class="fa fa-map"></i>
              <p>N.H 44, PAMPORE (GALANDER), KASHMIR 192121, India.</p>
            </div>
          </div>
          <div class="col-md-4">
            <div class="mail d-flex align-items-center">
              ...
              <div class="para">
                <p><a class="text-black" href="mailto: info@bomiskashmir.edu.in">
                    info@bomiskashmir.edu.in</a></p>
                <p><a class="text-black" href="mailto:  principal.jammu@birlaopenminds.com">
                    principal.pampore@birlaopenminds.com</a></p>
              </div>
            </div>
          </div>
        </div>
    ...
    <section class="map">
      <div class="container">
        <div class="col-md-12">
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d67921.1317022922!2d74.86983019216753!3d33.98622523427781!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x38e18bb7742a5113%3A0x2ca75c6cc5845e0a!2sBirla%20Open%20Minds%20International%20School!5e0!3m2!1sen!2sin!4v1619505370246!5m2!1sen!2sin"
    ...
    if (isset($_POST['submit'])) {
      ...
      $mail->addAddress('principal.pampore@birlaopenminds.com');
      $mail->isHTML(true);
