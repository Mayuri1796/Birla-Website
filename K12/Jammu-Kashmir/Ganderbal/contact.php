...
<body>
  <main id="birla">
        ...
        <div class="row">
          <div class="col-md-3">
            <div class="call_section d-flex align-items-center">
              ...
              <div class="para">
                <p><a class="text-black" href="tel: 91 9419229500"> 91 9419229500</a> / <a class="num"
                    href="tel: 91 9596032809">
                    91 9596032809 </a></p>
              </div>
            </div>
          </div>
          <div class="col-md-5">
            <div class="address d-flex align-items-center">
              <i class="fa fa-map"></i>
              <p>NH1, Kurhama, Ganderbal, J&K 191131, India</p>
            </div>
          </div>
          <div class="col-md-4">
            <div class="mail d-flex align-items-center">
              ...
              <div class="para">
                <p><a class="text-black" href="mailto: admissions.ganderbal@birlaopenminds.com">
                    admissions.ganderbal@birlaopenminds.com</a></p>
                <p><a class="text-black" href="mailto:  principal.ganderbal@birlaopenminds.com">
                    principal.ganderbal@birlaopenminds.com</a></p>
              </div>
            </div>
          </div>
        </div>
    ...
    if (isset($_POST['submit'])) {
      ...
      $mail->addAddress('principal.ganderbal@birlaopenminds.com');
      $mail->isHTML(true);
