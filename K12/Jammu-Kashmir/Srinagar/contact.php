  ...
  <main id="birla">
        ...
        <div class="row">
          <div class="col-md-3">
            <div class="call_section d-flex align-items-center">
              ...
              <div class="para">
                <p><a class="text-black" href="tel: 6006813016"> 6006813016</a> / <a class="num" href="tel: 6006698972">
                    6006698972 </a></p>
              </div>
            </div>
          </div>
          <div class="col-md-5">
            <div class="address d-flex align-items-center">
              <i class="fa fa-map"></i>
              <p>National Highway Lowaypora,
                adjacent to Hokersar Srinagar,
                Jammu and Kashmir 191111, India.</p>
            </div>
          </div>
          <div class="col-md-4">
            <div class="mail d-flex align-items-center">
              ...
              <div class="para">
                <p><a class="text-black" href="mailto: admissions.srinagar@birlaopenminds.com">
                    admissions.srinagar@birlaopenminds.com</a></p>
                <p><a class="text-black" href="mailto:  principal.srinagar@birlaopenminds.com">
                    principal.srinagar@birlaopenminds.com</a></p>
              </div>
            </div>
          </div>
        </div>
    ...
    <section class="map">
      <div class="container">
        <div class="col-md-12">
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d13212.3642388181!2d74.69026727359106!3d34.11841845387792!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x38e19bcd152ae507%3A0xde6a149089a6b345!2sLawaypora%20191111!5e0!3m2!1sen!2sin!4v1633586981250!5m2!1sen!2sin"
    ...
    if (isset($_POST['submit'])) {
      ...
      $mail->addAddress('principal.srinagar@birlaopenminds.com');
      $mail->isHTML(true);
