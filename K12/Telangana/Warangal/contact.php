  ...
  <main id="birla">
        ...
        <div class="row">
          <div class="col-md-3">
            <div class="call_section d-flex align-items-center">
              ...
              <div class="para">
                <p><a class="text-black" href="tel:+91 9581553300">+91 9581553300</a></p>
                <p> <a class="text-black" href="tel:+91 9581668811">+91 9581668811</a></p>
              </div>
            </div>
          </div>
          <div class="col-md-5">
            <div class="address d-flex align-items-center">
              <i class="fa fa-map"></i>
              <p>Behind Ganapathy Engineering College,
                Thimmapur Road,
                Warangal - 506005, India.</p>
            </div>
          </div>
          <div class="col-md-4">
            <div class="mail d-flex align-items-center">
              ...
              <div class="para">
                <p><a class="text-black" href="mailto:admissions.wgl@birlaopenminds.com">
                    admissions.wgl@birlaopenminds.com</a></p>
                <p><a class="text-black" href="mailto:birlaschool.wgl@gmail.com">
                    birlaschool.wgl@gmail.com</a></p>
              </div>
            </div>
          </div>
        </div>
    ...
    <section class="map">
      <div class="container">
        <div class="col-md-12">
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d3795.865267770687!2d79.584598!3d17.93
       8  437!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0xe9e60cc190b8816c!2sBirla%20Open%20Minds%20International%20School%20-%20Warangal!5e0!3m2!1sen!2sin!4v1646980696690!5m2!1sen!2sin"
    ...
    if (isset($_POST['submit'])) {
      ...
      $mail->addAddress('birlaschool.wgl@gmail.com');
      $mail->isHTML(true);
