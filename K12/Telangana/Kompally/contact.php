  ...
  <main id="birla">
        ...
        <div class="row">
          <div class="col-md-3">
            <div class="call_section d-flex align-items-center">
              ...
              <div class="para">
                <p><a class="text-black" href="tel:+91 9100094361">+91 9100094361</a></p>
              </div>
            </div>
          </div>
          <div class="col-md-5">
            <div class="address d-flex align-items-center">
              <i class="fa fa-map"></i>
              <p>85,Lotus, L&T Serene Country,
                Gachibowli,Hyderabad, India.</p>
            </div>
          </div>
          <div class="col-md-4">
            <div class="mail d-flex align-items-center">
              ...
              <div class="para">
                <p><a class="text-black" href="mailto:admissions.kompally@birlaopenminds.com">
                    admissions.kompally@birlaopenminds.com</a></p>
                <p><a class="text-black" href="mailto:ceo@dsr.edu.in">
                    ceo@dsr.edu.in</a></p>
              </div>
            </div>
          </div>
    ...
    <section class="map">
      <div class="container">
        <div class="col-md-12">
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m19!1m8!1m3!1d7613.054242088865!2d78.36331358234742!3d17.434466970258672!3m2!1i1024!2i768!4f13.1!4m8!3e3!4m0!4m5!1s0x3bcb93ed506655ff%3A0x41d7ca1c71b3c36d!2sSerene+County%2C+National+Institute+of+Tourism+and+Hospitality+Management%2C+Nehru+Outer+Ring+Road%2C+Opp+to%2C+Telecom+Nagar%2C+Gachibowli%2C+Hyderabad%2C+Telangana+500032!3m2!1d17.4336788!2d78.36231579999999!5e0!3m2!1sen!2sin!4v1549612327773"
    ...
    if (isset($_POST['submit'])) {
      ...
      $mail->addAddress('admissions.kompally@birlaopenminds.com');
      $mail->isHTML(true);
