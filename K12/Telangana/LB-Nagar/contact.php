  ...
  <main id="birla">
        ...
        <div class="row">
          <div class="col-md-3">
            <div class="call_section d-flex align-items-center">
              ...
              <div class="para">
                <p><a class="text-black" href="tel:(040) 24121234">(040) 24121234</a></p>
                <p> <a class="text-black" href="tel:+91 7337221234">+91 7337221234</a></p>
              </div>
            </div>
          </div>
          <div class="col-md-5">
            <div class="address d-flex align-items-center">
              <i class="fa fa-map"></i>
              <p>Sahara Rd, Behind Kamineni
                Hospitals, Mansoorabad, LB Nagar,
                Hyderabad, Telangana - 500068, India.</p>
            </div>
          </div>
          <div class="col-md-4">
            <div class="mail d-flex align-items-center">
              ...
              <div class="para">
                <p><a class="text-black" href="mailto:admissions.lbnagar@birlaopenminds.com">
                    admissions.lbnagar@birlaopenminds.com</a></p>
              </div>
            </div>
          </div>
        </div>
    ...
    <section class="map">
      <div class="container">
        <div class="col-md-12">
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d60933.1925205441!2d78.565799!3
      d   17.348110000000002!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0xe7b6cbe42e5dec69!2sBIRLA%20OPEN%20MINDS%20%7C%20CBSE%20SCHOOL%20IN%20LB%20NAGAR!5e0!3m2!1sen!2sin!4v1591108999545!5m2!1sen!2sin"
    ...
    if (isset($_POST['submit'])) {
      ...
      $mail->addAddress('admissions.lbnagar@birlaopenminds.com');
      $mail->isHTML(true);
