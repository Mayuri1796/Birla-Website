  ...
  <main id="birla">
        ...
        <div class="row">
          <div class="col-md-3">
            <div class="call_section d-flex align-items-center">
              ...
              <div class="para">
                <p><a class="text-black" href="tel:+91 7661897928">+91 7661897928</a></p>
              </div>
            </div>
          </div>
          <div class="col-md-5">
            <div class="address d-flex align-items-center">
              <i class="fa fa-map"></i>
              <p>Near Toll Plaza, Bibinagar,Yadadri
                District – Telangana
                Pin Code - 508126, India.</p>
            </div>
          </div>
          <div class="col-md-4">
            <div class="mail d-flex align-items-center">
              ...
              <div class="para">
                <p><a class="text-black" href="mailto: admissions.bibinagar@birlaopenminds.com">
                    admissions.bibinagar@birlaopenminds.com</a></p>
                <p><a class="text-black" href="mailto:principal.bibinagar@birlaopenminds.com">
                    principal.bibinagar@birlaopenminds.com</a></p>
              </div>
            </div>
          </div>
        </div>
    ...
    <section class="map">
      <div class="container">
        <div class="col-md-12">
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d243525.46816293141!2d78.73177505352372!3d17.503434401220684!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0xe6510c711eaaa086!2sShloka+A+Birla+School!5e0!3m2!1sen!2sin!4v1531738621824"
    ...
    if (isset($_POST['submit'])) {
      ...
      $mail->addAddress('principal.bibinagar@birlaopenminds.com');
      $mail->isHTML(true);
