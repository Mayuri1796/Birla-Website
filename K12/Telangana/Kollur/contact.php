  ...
  <main id="birla">
        ...
        <div class="row">
          <div class="col-md-3">
            <div class="call_section d-flex align-items-center">
              ...
              <div class="para">
                <p><a class="text-black" href="tel:+91 7660973334">+91 7660973334</a></p>
                <p> <a class="text-black" href="tel:+91 7337391977">+91 7337391977</a></p>
              </div>
            </div>
          </div>
          <div class="col-md-5">
            <div class="address d-flex align-items-center">
              <i class="fa fa-map"></i>
              <p> Near Financial District, kollur, Hyderabad, India.</p>
            </div>
          </div>
          <div class="col-md-4">
            <div class="mail d-flex align-items-center">
              ...
              <div class="para">
                <p><a class="text-black" href="mailto:ominfo@dsr.edu.in">
                    ominfo@dsr.edu.in</a></p>
              </div>
            </div>
          </div>
        </div>
    ...
    <section class="map">
      <div class="container">
        <div class="col-md-12">
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15226.145869185693!2d78.26831799999998!3d17.434019!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x867392f3f0d8b0b1!2sBirla+Open+Minds+School%2C+Hyderabad!5e0!3m2!1sen!2sin!4v1497939114237"
    ...
    if (isset($_POST['submit'])) {
      ...
      $mail->addAddress(' ominfo@dsr.edu.in');
      $mail->isHTML(true);
