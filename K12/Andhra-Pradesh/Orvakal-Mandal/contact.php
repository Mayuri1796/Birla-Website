  ...
  <main id="birla">
        ...
        <div class="row">
          <div class="col-md-3">
            <div class="call_section d-flex align-items-center">
              ...
              <div class="para">
                <p><a class="text-black" href="tel:+91 9550536586">+91 9550536586</a></p>
                <p> <a class="text-black" href="tel:+91 9550496586">+91 9550496586</a></p>
              </div>
            </div>
          </div>
          <div class="col-md-5">
            <div class="address d-flex align-items-center">
              <i class="fa fa-map"></i>
              <p>NH-40, Nannur, Kurnool, Andhra Pradesh - 518002, India.</p>
            </div>
          </div>
          <div class="col-md-4">
            <div class="mail d-flex align-items-center">
              ...
              <div class="para">
                <p><a class="text-black" href="mailto:admissions.kurnool@birlaopenminds.com">
                    admissions.kurnool@birlaopenminds.com</a></p>
                <p><a class="text-black" href="mailto:principal.kurnool@birlaopenminds.com">
                    principal.kurnool@birlaopenminds.com</a></p>
              </div>
            </div>
          </div>
        </div>
    ...
    <section class="map">
      <div class="container">
        <div class="col-md-12">
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3840.630703700135!2d78.09353141433259!3d15.717739852937477!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bb5e75568af7209%3A0xea2a0222da2badc7!2sNH40%2C%20Nannur%2C%20Andhra%20Pradesh!5e0!3m2!1sen!2sin!4v1644909255780!5m2!1sen!2sin"
    ...
    if (isset($_POST['submit'])) {
      ...
      $mail->addAddress('principal.kurnool@birlaopenminds.com');
      $mail->isHTML(true);
