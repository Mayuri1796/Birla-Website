...
<body>
  <main id="birla">
        ...
        <div class="row">
          ...
          <div class="col-md-5">
            <div class="address d-flex align-items-center">
              <i class="fa fa-map"></i>
              <p>Opp. Thondavada Village,
                Tirupati - Bengaluru High way, Anupam Nagar, Tirupati
                Dis. Chittoor, Andhra Pradesh - 517505, India.</p>
            </div>
          </div>
          <div class="col-md-4">
            <div class="mail d-flex align-items-center">
              ...
              <div class="para">
                <p><a class="text-black" href="mailto:principal.tpt@birlaopenminds.com">
                    principal.tpt@birlaopenminds.com</a></p>
                <p><a class="text-black" href="mailto:shlokatirupati@gmail.com">
                    shlokatirupati@gmail.com</a></p>
              </div>
            </div>
          </div>
        </div>
    ...
    if (isset($_POST['submit'])) {
      ...
      $mail->addAddress('principal.tpt@birlaopenminds.com');
      $mail->isHTML(true);
