...
<body>
  <main id="birla">
        ...
        <div class="row">
          <div class="col-md-3">
            <div class="call_section d-flex align-items-center">
              ...
              <div class="para">
                <p><a class="text-black" href="tel: 91 9760300444"> 91 9760300444</a> </p>
                <p><a class="text-black" href="tel:91 9760700444">91
                    9760700444 </a></p>
              </div>
            </div>
          </div>
          <div class="col-md-5">
            <div class="address d-flex align-items-center">
              <i class="fa fa-map"></i>
              <p>Sihniwala, P.O. Sherpur, Shimla Road, Dehradun, India.</p>
            </div>
          </div>
          <div class="col-md-4">
            <div class="mail d-flex align-items-center">
              ...
              <div class="para">
                <p><a class="text-black" href="mailto: admission@bomis.org">
                    admission@bomis.org</a></p>
                <p><a class="text-black" href="mailto: centrehead.ddn@birlaopenminds.com">
                    centrehead.ddn@birlaopenminds.com</a></p>
              </div>
            </div>
          </div>
        </div>
                ...
                <form autocomplete="off" action="" method="post" class="form d-block" role="form">
                  ...
                  <div class="form-group">
                    <select class="form-control inputBox" name="school_type" id="inputEmail3" required="">
                      <option>Shimla-Road-Dehradun</option>
                    </select>
                  </div>
    ...
    if (isset($_POST['submit'])) {
      ...
      $mail->addAddress('centrehead.ddn@birlaopenminds.com');
      $mail->isHTML(true);
      ...
      if (mail($to, $subject, $message, $headers)) {
        ...
        echo '<p style="color: red;">Error ssending the form. Please try again later.</p>';
      }
    }
    ?>
