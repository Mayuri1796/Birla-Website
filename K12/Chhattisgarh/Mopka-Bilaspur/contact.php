  ...
  <main id="birla">
        ...
        <div class="row">
          <div class="col-md-3">
            <div class="call_section d-flex align-items-center">
              ...
              <div class="para">
                <p><a class="text-black" href="tel:+91 8815105682">+91 8815105682</a></p>
                <p> <a class="text-black" href="tel:+91 8815105684">+91 8815105684</a></p>
              </div>
            </div>
          </div>
          <div class="col-md-5">
            <div class="address d-flex align-items-center">
              <i class="fa fa-map"></i>
              <p>Mopka - Koni Bypass, Mopka, Bilaspur, Chhattisgarh - 495006, India.</p>
            </div>
          </div>
          <div class="col-md-4">
            <div class="mail d-flex align-items-center">
              ...
              <div class="para">
                <p><a class="text-black" href="mailto:admissions.bomisbilaspur@birlaopenminds.com">
                    admissions.bomisbilaspur@birlaopenminds.com</a></p>
                <p><a class="text-black" href="mailto:centrehead.bilaspur@birlaopenminds.com">
                    centrehead.bilaspur@birlaopenminds.com</a></p>
              </div>
            </div>
          </div>
        </div>
    ...
    <section class="map">
      <div class="container">
        <div class="col-md-12">
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3696.639981534038!2d82.20818888009721!3d22.10156202782292!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a280bd1db5bbe3b%3A0xf8784c9f759e3384!2sBirla%20Open%20Minds%20International%20School%2C%20Bilaspur!5e0!3m2!1sen!2sin!4v1690008691892!5m2!1sen!2sin"
    ...
    if (isset($_POST['submit'])) {
      ...
      $mail->addAddress('centrehead.bilaspur@birlaopenminds.com');
      $mail->isHTML(true);
