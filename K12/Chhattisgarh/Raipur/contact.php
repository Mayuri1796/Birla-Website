  ...
  <main id="birla">
        ...
        <div class="row">
          <div class="col-md-3">
            <div class="call_section d-flex align-items-center">
              ...
              <div class="para">
                <p><a class="text-black" href="tel:+91 9425531003">+91 9425531003</a></p>
                <p> <a class="text-black" href="tel:+91 9893271003">+91 9893271003</a></p>
              </div>
            </div>
          </div>
          <div class="col-md-5">
            <div class="address d-flex align-items-center">
              <i class="fa fa-map"></i>
              <p>DNS Group of Institutions Village Didauli,
                NH 24, Dist Amroha - 244222, Uttar Pradesh, India.</p>
            </div>
          </div>
          <div class="col-md-4">
            <div class="mail d-flex align-items-center">
              ...
              <div class="para">
                <p><a class="text-black" href="mailto:admissions.raipur@birlaopenminds.com">
                    admissions.raipur@birlaopenminds.com</a></p>
                <p><a class="text-black" href="mailto:ch_raipur@birlaopenminds.com">
                    ch_raipur@birlaopenminds.com</a></p>
              </div>
            </div>
          </div>
        </div>
    ...
    <section class="map">
      <div class="container">
        <div class="col-md-12">
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d13981.331899178216!2d78.5204492!3d28.8289451!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0xecbed8d03de7289a!2sDNS%20College%20Of%20Engineering%20And%20Technology!5e0!3m2!1sen!2sin!4v1585032222759!5m2!1sen!2sin"
    ...
    if (isset($_POST['submit'])) {
      ...
      $mail->addAddress('ch_raipur@birlaopenminds.com');
      $mail->isHTML(true);
