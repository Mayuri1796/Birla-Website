  ...
  <main id="birla">
        ...
        <div class="row">
          ...
          <div class="col-md-5">
            <div class="address d-flex align-items-center">
              <i class="fa fa-map"></i>
              <p> Rosera Mabbi Road,
                Main Road Opposite to Dargah,
                Rosera (Samastipur), Bihar - 848210, India.</p>
            </div>
          </div>
          <div class="col-md-4">
            <div class="mail d-flex align-items-center">
              ...
              <div class="para">
                <p><a class="text-black" href="mailto:admissions.munger@birlaopenminds.com">
                    admissions.rosera@birlaopenminds.com</a></p>
                <p><a class="text-black" href="mailto: principal.munger@birlaopenminds.com">
                    principal.rosera@birlaopenminds.com</a></p>
              </div>
            </div>
          </div>
        </div>
    ...
    <section class="map">
      <div class="container">
        <div class="col-md-12">
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3593.576239385868!2d86.05250381502074!3d25.75152368364135!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39edf1c64428905b%3A0xc49f001e0eb51bd!2sBirla%20Open%20Minds%20International%20School%20Rosera!5e0!3m2!1sen!2sin!4v1610626618766!5m2!1sen!2sin"
    ...
    if (isset($_POST['submit'])) {
      ...
      $mail->addAddress('principal.rosera@birlaopenminds.com');
      $mail->isHTML(true);
