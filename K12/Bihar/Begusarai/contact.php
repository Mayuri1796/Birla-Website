...
<body>
  <main id="birla">
        ...
        <div class="row">
          <div class="col-md-3">
            <div class="call_section d-flex align-items-center">
              ...
              <div class="para">
                <p><a class="text-black" href="tel:+91 9546949541">+91 9546949541</a> </p>
                <p><a class="text-black" href="tel:+91 8873119000">+91 8873119000</a> </p>
              </div>
            </div>
          </div>
          <div class="col-md-5">
          ...
          <div class="col-md-4">
            <div class="mail d-flex align-items-center">
              ...
              <div class="para">
                <p><a class="text-black" href="mailto:admissions.begusarai@birlaopenminds.com">
                    admissions.begusarai@birlaopenminds.com</a></p>
                <p><a class="text-black" href="mailto:principal.begusarai@birlaopenminds.com">
                    principal.begusarai@birlaopenminds.com</a></p>
              </div>
            </div>
          </div>
        </div>
    ...
    if (isset($_POST['submit'])) {
      ...
      $mail->addAddress('principal.begusarai@birlaopenminds.com');
      $mail->isHTML(true);
