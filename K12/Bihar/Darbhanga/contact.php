  ...
  <main id="birla">
        ...
        <div class="row">
          <div class="col-md-3">
            <div class="call_section d-flex align-items-center">
              ...
              <div class="para">
                <p><a class="text-black" href="tel:+91 7360901111">+91 7360901111</a></p>
                <p> <a class="text-black" href="tel:+91 7360902222">+91 7360902222</a></p>
              </div>
            </div>
          </div>
          <div class="col-md-5">
            <div class="address d-flex align-items-center">
              <i class="fa fa-map"></i>
              <p>Exit before Ansar Garden,
                Loam Road, E - West Corridor,
                Near Jiwach Ghat Mandir,
                Darbhanga, Bihar 846004, India.</p>
            </div>
          </div>
          <div class="col-md-4">
            <div class="mail d-flex align-items-center">
              ...
              <div class="para">
                <p><a class="text-black" href="mailto:admissions.darbangha@birlaopenminds.com">
                    admissions.darbangha@birlaopenminds.com</a></p>
                <p><a class="text-black" href="mailto: principal.darbangha@birlaopenminds.com">
                    principal.darbangha@birlaopenminds.com</a></p>
              </div>
            </div>
          </div>
        </div>
    ...
    <section class="map">
      <div class="container">
        <div class="col-md-12">
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d14319.959714100944!2d85.9976636!3d26.1970059!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x56f34cf493d72002!2sBirla%20Open%20Minds%20International%20School%20Darbhanga!5e0!3m2!1sen!2sin!4v1646291895061!5m2!1sen!2sin"
    ...
    if (isset($_POST['submit'])) {
      ...
      $mail->addAddress('principal.darbangha@birlaopenminds.com');
      $mail->isHTML(true);
