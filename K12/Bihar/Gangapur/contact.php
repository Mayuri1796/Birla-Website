  ...
  <main id="birla">
        ...
        <div class="row">
          <div class="col-md-3">
            <div class="call_section d-flex align-items-center">
              ...
              <div class="para">
                <p><a class="text-black" href="tel:+91 9931042284">+91 9931042284</a></p>
                <p> <a class="text-black" href="tel:+91 9122701341">+91 9122701341</a></p>
              </div>
            </div>
          </div>
          <div class="col-md-5">
            <div class="address d-flex align-items-center">
              <i class="fa fa-map"></i>
              <p>
                Tajpur Road, Dudhpura(Near Airport),
                Samastipur 848101, India.</p>
            </div>
          </div>
          <div class="col-md-4">
            <div class="mail d-flex align-items-center">
              ...
              <div class="para">
                <p><a class="text-black" href="mailto:admissions.gangapur@birlaopenminds.com">
                    admissions.gangapur@birlaopenminds.com</a></p>
                <p><a class="text-black" href="mailto: principal.gangapur@birlaopenminds.com">
                    principal.gangapur@birlaopenminds.com</a></p>
              </div>
            </div>
          </div>
        </div>
    ...
    <section class="map">
      <div class="container">
        <div class="col-md-12">
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d57458.467518725214!2d85.67911145527712!3d25.831463042969173!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39ed9b122a84588f%3A0xc4b33fb7226b698d!2sGanga%20Pur%2C%20Bihar!5e0!3m2!1sen!2sin!4v1585562312419!5m2!1sen!2sin"
    ...
    if (isset($_POST['submit'])) {
      ...
      $mail->addAddress('principal.gangapur@birlaopenminds.com');
      $mail->isHTML(true);
