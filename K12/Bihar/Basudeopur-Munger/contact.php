  ...
  <main id="birla">
        ...
        <div class="row">
          <div class="col-md-3">
            <div class="call_section d-flex align-items-center">
              ...
              <div class="para">
                <p><a class="text-black" href="tel:+91 8797495211">+91 8797495211</a></p>
                <p> <a class="text-black" href="tel:+91 8797495212">+91 8797495212</a></p>
              </div>
            </div>
          </div>
          <div class="col-md-5">
            <div class="address d-flex align-items-center">
              <i class="fa fa-map"></i>
              <p>C/o Md.Afroz Khan,
                AT- Naya, Gawan Rajsher,
                PO - Basudeopur, Munger - 811202, Bihar, India.</p>
            </div>
          </div>
          <div class="col-md-4">
            <div class="mail d-flex align-items-center">
              ...
              <div class="para">
                <p><a class="text-black" href="mailto:admissions.munger@birlaopenminds.com">
                    admissions.munger@birlaopenminds.com</a></p>
                <p><a class="text-black" href="mailto: principal.munger@birlaopenminds.com">
                    principal.munger@birlaopenminds.com</a></p>
              </div>
            </div>
          </div>
        </div>
    ...
    <section class="map">
      <div class="container">
        <div class="col-md-12">
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d28835.893803251252!2d86.45658073389069!3d25.38851331366742!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39f1ef20d8b2e98f%3A0x93bc6468fb6782e2!2sBasudevpur%2C%20Munger%2C%20Bihar%20811201!5e0!3m2!1sen!2sin!4v1598012439040!5m2!1sen!2sin"
                ...
                <form autocomplete="off" action="" method="post" class="form d-block" role="form">
                  ...
                  <div class="form-group">
                    <select class="form-control inputBox" name="school_type" id="inputEmail3" required="">
                      <option>Basudeopur-Munger</option>
                    </select>
                  </div>
    ...
    if (isset($_POST['submit'])) {
      ...
      $mail->addAddress('principal.munger@birlaopenminds.com');
      $mail->isHTML(true);
