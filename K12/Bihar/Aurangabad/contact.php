  ...
  <main id="birla">
        ...
        <div class="row">
          <div class="col-md-3">
            <div class="call_section d-flex align-items-center">
              ...
              <div class="para">
                <p><a class="text-black" href="tel:+91 8797495211">+91 9472311000</a></p>
                <p> <a class="text-black" href="tel:+91 8797495212">+91 6203336343</a></p>
              </div>
            </div>
          </div>
          <div class="col-md-5">
            <div class="address d-flex align-items-center">
              <i class="fa fa-map"></i>
              <p> Baratpur Mohalla, Near Baratpur Akhara,
                Aurangabad, Bihar - 824101, India.</p>
            </div>
          </div>
          <div class="col-md-4">
            <div class="mail d-flex align-items-center">
              ...
              <div class="para">
                <p><a class="text-black" href="mailto:admissions.aurangabad@birlaopenminds.com">
                    admissions.aurangabad@birlaopenminds.com</a></p>
                <p><a class="text-black" href="mailto: principal.aurangabad@birlaopenminds.com">
                    principal.aurangabad@birlaopenminds.com</a></p>
              </div>
            </div>
          </div>
        </div>
    ...
    <section class="map">
      <div class="container">
        <div class="col-md-12">
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d7246.485253618657!2d84.37954618100208!3d24.75286898248052!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x398cfdb370dbfcff%3A0x9e3ebb16f1c2c3b6!2sbaratpur+akhada+near+rajarshi+vidya+mandir+aurangabad+bihar!5e0!3m2!1sen!2sin!4v1549609609705"
    ...
    if (isset($_POST['submit'])) {
      ...
      $mail->addAddress('principal.aurangabad@birlaopenminds.com');
      $mail->isHTML(true);
