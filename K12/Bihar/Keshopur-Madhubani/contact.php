...
<body>
  <main id="birla">
          ...
          <div class="col-md-3">
            <div class="call_section d-flex align-items-center">
              ...
              <div class="para">
                ...
                <p> <a class="text-black" href="tel:+91 9431821242">+91 9431821242</a></p>
              </div>
            </div>
          </div>
          <div class="col-md-5">
            <div class="address d-flex align-items-center">
              <i class="fa fa-map"></i>
              <p> Behind Madhubani Medical College & Hospital, Madhubani - Sakri - Pandaul Road,
                Keshopur, Madhubani - 847212, Bihar, India.</p>
            </div>
          </div>
          <div class="col-md-4">
            <div class="mail d-flex align-items-center">
              ...
              <div class="para">
                <p><a class="text-black" href="mailto:admissions.madhubani@birlaopenminds.com">
                    admissions.madhubani@birlaopenminds.com</a></p>
                <p><a class="text-black" href="mailto: principal.madhubani@birlaopenminds.com">
                    principal.madhubani@birlaopenminds.com</a></p>
              </div>
            </div>
          </div>
        </div>
                ...
                <form autocomplete="off" action="" method="post" class="form d-block" role="form">
                  ...
                  <div class="form-group">
                    <select class="form-control inputBox" name="school_type" id="inputEmail3" required="">
                      <option>Keshopur-Madhubani</option>
                    </select>
                  </div>
    ...
    if (isset($_POST['submit'])) {
      ...
      $mail->addAddress('principal.madhubani@birlaopenminds.com');
      $mail->isHTML(true);
