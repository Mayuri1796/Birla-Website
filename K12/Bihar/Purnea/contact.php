...
<body>
  <main id="birla">
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            <div class="mail d-flex align-items-center">
              ...
              <div class="para">
                <p><a class="text-black" href="mailto:principal.purnia@birlaopenminds.com">
                    principal.purnia@birlaopenminds.com</a></p>
                <p><a class="text-black" href="mailto:admissions.purnia@birlaopenminds.com">
                    admissions.purnia@birlaopenminds.com</a></p>
              </div>
            </div>
          </div>
        </div>
    ...
    if (isset($_POST['submit'])) {
      ...
      $mail->addAddress('principal.purnia@birlaopenminds.com');
      $mail->isHTML(true);
