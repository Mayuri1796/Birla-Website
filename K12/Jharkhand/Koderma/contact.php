...
<body>
  <main id="birla">
        ...
        <div class="row">
          <div class="col-md-3">
            <div class="call_section d-flex align-items-center">
              ...
              <div class="para">
                <p><a class="text-black" href="tel: 91 9608138689"> 91 9608138689</a>></p>
              </div>
            </div>
          </div>
          <div class="col-md-5">
            <div class="address d-flex align-items-center">
              <i class="fa fa-map"></i>
              <p>Behind Madhubani Medical College & Hospital,
                Madhubani - Sakri - Pandaul Road,
          ...
          <div class="col-md-4">
            <div class="mail d-flex align-items-center">
              ...
              <div class="para">
                <p><a class="text-black" href="mailto: admissions.koderma@birlaopenminds.com">
                    admissions.koderma@birlaopenminds.com</a></p>
                <p><a class="text-black" href="mailto:  principal.koderma@birlaopenminds.com">
                    principal.koderma@birlaopenminds.com</a></p>
              </div>
            </div>
          </div>
        </div>
    ...
    if (isset($_POST['submit'])) {
      ...
      $mail->addAddress('principal.koderma@birlaopenminds.com');
      $mail->isHTML(true);
