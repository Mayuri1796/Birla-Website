  ...
  <main id="birla">
        ...
        <div class="row">
          <div class="col-md-3">
            <div class="call_section d-flex align-items-center">
              ...
              <div class="para">
                <p><a class="text-black" href="tel:+91 7036620222">+91 7036620222</a></p>
                <p><a class="text-black" href="tel:+91 8939031234">+91 8939031234</a></p>
              </div>
            </div>
          </div>
          <div class="col-md-5">
            <div class="address d-flex align-items-center">
              <i class="fa fa-map"></i>
              <p>Door No: #6A Old S.No: 498/2,
                T.S.No: 49/3,
                Chelliamman Koil Street,
                Athipet, Ambattur,
                Chennai - 600 058., India.</p>
            </div>
          </div>
          <div class="col-md-4">
            <div class="mail d-flex align-items-center">
              ...
              <div class="para">
                <p><a class="text-black" href="mailto:admissions.mogappair@birlaopenminds.com">
                    admissions.mogappair@birlaopenminds.com</a></p>
                <p><a class="text-black" href="mailto:principal.mogappair@birlaopenminds.com">
                    principal.mogappair@birlaopenminds.com</a></p>
              </div>
            </div>
          </div>
        </div>
    ...
    <section class="map">
      <div class="container">
        <div class="col-md-12">
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d31092.383123772543!2d80.14339905279111!3d13.064424834590662!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a52614ad02126a5%3A0xc121b02b262dadc1!2sBirla%20Open%20Minds%20Preschool%2C%20Valasaravakkam%2C%20Chennai!5e0!3m2!1sen!2sin!4v1690192138816!5m2!1sen!2sin"
                ...
                <form autocomplete="off" action="" method="post" class="form d-block" role="form">
                  ...
                  <div class="form-group">
                    <select class="form-control inputBox" name="school_type" id="inputEmail3" required="">
                      <option>Mogappair-Chennai</option>
                    </select>
                  </div>
    ...
    if (isset($_POST['submit'])) {
      ...
      $mail->addAddress('principal.mogappair@birlaopenminds.com');
      $mail->isHTML(true);
