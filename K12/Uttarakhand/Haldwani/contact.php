  ...
  <main id="birla">
        ...
        <div class="row">
          <div class="col-md-3">
            <div class="call_section d-flex align-items-center">
              ...
              <div class="para">
                <p><a class="text-black" href="tel: +91 8595107113"> +91 8595107113</a>></p>
              </div>
            </div>
          </div>
          <div class="col-md-5">
            <div class="address d-flex align-items-center">
              <i class="fa fa-map"></i>
              <p>5FVR+VG3, Raja Rani Vihar Rd, Vasudevpuram, Niliam Colony, Haldwani, Prempur loshgyani, Uttarakhand
                263139, India</p>
            </div>
          </div>
          <div class="col-md-4">
            <div class="mail d-flex align-items-center">
              ...
              <div class="para">
                <p><a class="text-black" href="mailto: admissions.haldwani@birlaopenminds.com">
                    admissions.haldwani@birlaopenminds.com</a></p>
                <p><a class="text-black" href="mailto:  principal.haldwani@birlaopenminds.com">
                    principal.haldwani@birlaopenminds.com</a></p>
              </div>
            </div>
          </div>
        </div>
    ...
    <section class="map">
      <div class="container">
        <div class="col-md-12">
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3482.9830353807315!2d79.48870917540246!3d29.19462637536255!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39a09b4980a8bb6d%3A0x613a66d7af7097da!2sAryaman%20Vikram%20Birla%20Institute%20Of%20Learning!5e0!3m2!1sen!2sin!4v1690266242166!5m2!1sen!2sin"
    ...
    if (isset($_POST['submit'])) {
      ...
      $mail->addAddress('principal.haldwani@birlaopenminds.com');
      $mail->isHTML(true);
