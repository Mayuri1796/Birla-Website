  ...
  <main id="birla">
        ...
        <div class="row">
          <div class="col-md-3">
            <div class="call_section d-flex align-items-center">
              ...
              <div class="para">
                <p><a class="text-black" href="tel:+91 9607999079">+91 9607999079</a> </p>
                <p><a class="text-black" href="tel:+91 9607999080">+91 9607999080</a></p>
              </div>
            </div>
          </div>
          <div class="col-md-5">
            <div class="address d-flex align-items-center">
              <i class="fa fa-map"></i>
              <p>Survey No.248/1, Vyankatesh Nagar, Behind Urdu School, Papvinash Road,
                Near Bus Stand No.2, Latur - 413512 (M. S.)</p>
            </div>
          </div>
          <div class="col-md-4">
            <div class="mail d-flex align-items-center">
              ...
              <div class="para">
                ...
                <p><a class="text-black" href="mailto:adm.latur@birlaopenminds.com"> adm.latur@birlaopenminds.com</a>
                </p>
                <p><a class="text-black" href="mailto:principal.latur@birlaopenminds.com">
                    principal.latur@birlaopenminds.com</a></p>
              </div>
            </div>
          </div>
        </div>
    ...
    <section class="map">
      <div class="container">
        <div class="col-md-12">
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3785.641676154641!2d76.57216137505947!3d18.40915228266294!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bcf83928891038f%3A0x795e7dbdcf1b184f!2sBirla%20Open%20Minds%20International%20School%2C%20Latur!5e0!3m2!1sen!2sin!4v1689833420311!5m2!1sen!2sin"
    ...
    if (isset($_POST['submit'])) {
      ...
      $mail->addAddress('principal.latur@birlaopenminds.com');
      $mail->isHTML(true);
