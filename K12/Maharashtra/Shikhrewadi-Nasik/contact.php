...
<body>
  <main id="birla">
        ...
        <div class="row">
          <div class="col-md-3">
            <div class="call_section d-flex align-items-center">
              ...
              <div class="para">
                <p><a class="text-black" href="tel:+91 9820435344">+91 9820435344</a> </p>
              </div>
            </div>
          </div>
          <div class="col-md-5">
            <div class="address d-flex align-items-center">
              <i class="fa fa-map"></i>
              <p>Near Shikhrewadi Jogging Track,
                Lic road, Shikhrewadi, Nashik-422101</p>
            </div>
          </div>
          <div class="col-md-4">
            <div class="mail d-flex align-items-center">
              ...
              <div class="para">
                <p><a class="text-black"
                    href="mailto:admissions.nashik@birlaopenminds.com">admissions.nashik@birlaopenminds.com</a> </p>
              </div>
            </div>
          </div>
        </div>
                ...
                <form autocomplete="off" action="" method="post" class="form d-block" role="form">
                  ...
                  <div class="form-group">
                    <select class="form-control inputBox" name="school_type" id="inputEmail3" required="">
                      <option>Shikhrewadi-Nasik</option>
                    </select>
                  </div>
    ...
    if (isset($_POST['submit'])) {
      ...
      $mail->addAddress('admissions.nashik@birlaopenminds.com');
      $mail->isHTML(true);
