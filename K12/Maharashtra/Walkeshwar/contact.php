  ...
  <main id="birla">
        ...
        <div class="row">
          <div class="col-md-3">
            <div class="call_section d-flex align-items-center">
              ...
              <div class="para">
                <p><a class="text-black" href="tel:+91 9987872231">+91 9987872231</a> </p>
                <p><a class="text-black" href="tel:022 23693063"> 022 23693063</a></p>
              </div>
            </div>
          </div>
          <div class="col-md-5">
            <div class="address d-flex align-items-center">
              <i class="fa fa-map"></i>
              <p>Adjacent to Gopi Birla Memorial School, 68,
                Krishanaraj Society, Walkeshwar, Malabar Hill,
                Mumbai - 400006 , Maharashtra, India.</p>
            </div>
          </div>
          <div class="col-md-4">
            <div class="mail d-flex align-items-center">
              ...
              <div class="para">
                <p><a class="text-black"
                    href="mailto:admissions.bomis@birlaopenminds.com">admissions.bomis@birlaopenminds.com</a></p>
                <p><a class="text-black"
                    href="mailto:principal.bomis@birlaopenminds.com">principal.bomis@birlaopenminds.com</a></p>
              </div>
            </div>
          </div>
        </div>
    ...
    <section class="map">
      <div class="container">
        <div class="col-md-12">
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3773.534316657534!2d72.8008566750732!3d18.95199588222721!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be7d1ec0550518f%3A0x701735598a51a2!2sBirla%20Open%20Minds%20International%20School!5e0!3m2!1sen!2sin!4v1688726940082!5m2!1sen!2sin"
    ...
    if (isset($_POST['submit'])) {
      ...
      $mail->addAddress('principal.bomis@birlaopenminds.com');
      $mail->isHTML(true);
