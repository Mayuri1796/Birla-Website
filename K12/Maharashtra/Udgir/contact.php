  ...
  <main id="birla">
        ...
        <div class="row">
          <div class="col-md-3">
            <div class="call_section d-flex align-items-center">
              ...
              <div class="para">
                <p><a class="text-black" href="tel:+91 8448440270">+91 8448440270</a> </p>
                <p><a class="text-black" href="tel:+91 6269997777">+91 6269997777</a></p>
              </div>
            </div>
          </div>
          <div class="col-md-5">
            <div class="address d-flex align-items-center">
              <i class="fa fa-map"></i>
              <p>Bodahan Nagar, Jalkot Road, Udgir, TQ-Udgir, Dist-Latur, Maharashtra- 413517, India.</p>
            </div>
          </div>
          <div class="col-md-4">
            <div class="mail d-flex align-items-center">
              ...
              <div class="para">
                <p><a class="text-black" href="mailto: admissions.udgir@birlaopenminds.com">
                    admissions.udgir@birlaopenminds.com</a></p>
                <p><a class="text-black" href="mailto: principal.udgir@birlaopenminds.com">
                    principal.udgir@birlaopenminds.com</a></p>
              </div>
            </div>
          </div>
        </div>
    ...
    <section class="map">
      <div class="container">
        <div class="col-md-12">
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3785.7247254439562!2d77.13243897505933!3d18.40537538266595!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bcfab3cb4cb4ddb%3A0x6a00a485f0f0ed83!2sBirla%20Open%20Minds%20International%20School%2C%20Udgir!5e0!3m2!1sen!2sin!4v1689834077659!5m2!1sen!2sin"
    ...
    if (isset($_POST['submit'])) {
      ...
      $mail->addAddress('admissions.udgir@birlaopenminds.com');
      $mail->isHTML(true);
