  ...
  <main id="birla">
        ...
        <div class="row">
          <div class="col-md-3">
            <div class="call_section d-flex align-items-center">
              ...
              <div class="para">
                <p><a class="text-black" href="tel:+91 9902876174">+91 9902876174</a></p>
              </div>
            </div>
          </div>
          <div class="col-md-5">
            <div class="address d-flex align-items-center">
              <i class="fa fa-map"></i>
              <p>Sy.No:22/4, Udnoor,
                Near High Court, Udnoor Road,
                Gulbarga/Kalaburagi,
                Karnataka- 585102, India.</p>
            </div>
          </div>
          <div class="col-md-4">
            <div class="mail d-flex align-items-center">
              ...
              <div class="para">
                <p><a class="text-black" href="mailto:adm.kalburgi@shlokaschool.com">
                    adm.kalburgi@shlokaschool.com</a></p>
              </div>
            </div>
          </div>
        </div>
    ...
    <section class="map">
      <div class="container">
        <div class="col-md-12">
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d15237.660574054318!2d76.7997553!3d17.2955077!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x90198b0785f612d!2sBIRLA%20OPEN%20MINDS%20INTERNATIONAL%20SCHOOL!5e0!3m2!1sen!2sin!4v1567502510740!5m2!1sen!2sin"
    ...
    if (isset($_POST['submit'])) {
      ...
      $mail->addAddress('adm.kalburgi@shlokaschool.com');
      $mail->isHTML(true);
