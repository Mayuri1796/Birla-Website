  ...
  <main id="birla">
        ...
        <div class="row">
          <div class="col-md-3">
            <div class="call_section d-flex align-items-center">
              ...
              <div class="para">
                <p><a class="text-black" href="tel:+91 8105466633">+91 8105466633</a></p>
                <p><a class="text-black" href="tel:+91 8105466633">+91 8105466633</a></p>
              </div>
            </div>
          </div>
          <div class="col-md-5">
            <div class="address d-flex align-items-center">
              <i class="fa fa-map"></i>
              <p>50/1, Margondanahalli, Kithagnur Main Road,
                Hebron Enclave Road, Bengaluru – 560036., Karnataka, India.</p>
            </div>
          </div>
          <div class="col-md-4">
            <div class="mail d-flex align-items-center">
              ...
              <div class="para">
                <p><a class="text-black" href="mailto:admissions.mogappair@birlaopenminds.com">
                    admissions.krpuram@birlaopenminds.com</a></p>
    ...
    <section class="map">
      <div class="container">
        <div class="col-md-12">
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3887.0152304546727!2d77.69672061482268!3d13.034701990814597!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bae1149fc139d73%3A0xa28f901087b63db!2sIndian%20School%20of%20Excellence%20%7C%20CBSE%20School%20in%20K%20R%20Puram!5e0!3m2!1sen!2sin!4v1643788797680!5m2!1sen!2sin"
                ...
                <form autocomplete="off" action="" method="post" class="form d-block" role="form">
                  ...
                  <div class="form-group">
                    <select class="form-control inputBox" name="school_type" id="inputEmail3" required="">
                      <option>KR-Puram-Banglore</option>
                    </select>
                  </div>
